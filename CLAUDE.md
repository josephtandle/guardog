...
This project is indexed by GitNexus as **guardog** (948 symbols, 1505 relationships, 48 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/guardog/context` | Codebase overview, check index freshness |
| `gitnexus://repo/guardog/clusters` | All functional areas |
| `gitnexus://repo/guardog/processes` | All execution flows |
| `gitnexus://repo/guardog/process/{name}` | Step-by-step execution trace |
