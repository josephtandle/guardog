...
async function runTests() {
  ...
  await test.run('Autonomizer contract and version tracking', async () => {
    ...
    test.assert(contract.version === '3.0.1', 'Guard Dog contract version should be tracked');
    ...
    test.assert(packageJson.version === contract.version, 'Guard Dog package and contract versions should agree');
  });
